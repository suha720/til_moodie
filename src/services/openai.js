...
⚠️ 아래 예시는 출력 형식을 설명하기 위한 것이며, 
그대로 복사하거나 출력하지 마세요. 
반드시 제공된 period, averages, topKeywords, entries 내용을 기반으로 작성하세요.
...
{
  "summary": {
    "title": "<이 주의 감정 흐름 요약 제목>",
    "description": "<이 주의 감정 전반을 2~3문장으로 요약>"
  },
  "tips": [
    { "title": "<조언 제목1>", "description": "<구체적 실행 방법 포함한 조언 내용>" },
    { "title": "<조언 제목2>", "description": "<구체적 실행 방법 포함한 조언 내용>" },
    { "title": "<조언 제목3>", "description": "<구체적 실행 방법 포함한 조언 내용>" }
  ],
  "highlights": [
    "<이 주의 인상적인 사건·포인트1>",
    "<이 주의 인상적인 사건·포인트2>",
...
[작성 규칙]
- averages, topKeywords, entries를 근거로 구체적·현실적인 내용 작성
- 과한 칭찬·명령조는 피하고 따뜻한 톤 유지
- 불필요한 접두어나 설명 없이 스키마에 맞게만 출력`.trim(),
      },
      {
        role: "user",
